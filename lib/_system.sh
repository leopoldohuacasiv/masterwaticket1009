...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Descargando el código Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Actualicemos el sistema Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Borremos Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Bloqueemos Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Desbloqueemos Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Desbloqueo de la instancia/empresa ${empresa_desbloquear} llevado a cabo con éxito ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Cambiemos los dominios de Whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Cambio de dominio de la Instancia/Empresa ${empresa_dominio} llevado a cabo con éxito ...${GRAY_LIGHT}"
  printf "\n\n"
...
system_puppeteer_dependencies() {
  print_banner
  printf "${WHITE} 💻 Instalación de dependencias y librerias...${GRAY_LIGHT}"
  printf "\n\n"
