...
get_mysql_root_password() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese contraseña para el usuario de Implementación y Base de datos (No use caracteres especiales):${GRAY_LIGHT}"
  printf "\n\n"
...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingresa el enlace GITHUB del Whaticket que deseas instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
get_max_whats() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese el número de conexiones para ${instancia_add} que puedes registrar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_whats
}
...
get_max_user() {
  ...
  print_banner
  printf "${WHITE} 💻 Informar el número de usuarios que ${instancia_add} que puedes registrar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_user
}
...
get_frontend_url() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese el dominio FRONTEND/PAINEL para ${instancia_add}:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " frontend_url
}
...
get_redis_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese el puerto REDIS/AGENDAMENTO MSG para el ${instancia_add}; Ex: 5000 A 5999 ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " redis_port
}
...
get_alter_frontend_url() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese el dominio nuevo FRONTEND/PANEL para ${empresa_dominio}:${GRAY_LIGHT}"
  printf "\n\n"
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bienvenido al Instalador Whaticket-Saas. ¡Seleccione la acción a realizar!${GRAY_LIGHT}"
  printf "\n\n"
  ...
  printf "   [5] Alterar dominio Whaticket\n"
  printf "\n"
  read -p "> " option
